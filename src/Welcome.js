...
export default function Welcome() {
  return (
    <div className="content">
      ...
      <p>Professional coders aren&quote;t necessarily male. That is what we see as an undeniable fact, but also as a statement we want to enforce in the real world. That&quote;s why we hope you&quote;ll join us in making this difference. Research points out that diversity in the workspace can lead to a more productive and efficient work environment.</p>
